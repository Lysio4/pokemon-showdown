...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Chien-Pao', 'Comfey', 'Darmanitan', 'Darmanitan-Galar', 'Darmanitan-Galar-Zen', 'Deoxys-Normal', 'Deoxys-Attack', 'Dhelmise', 'Dialga', 'Dondozo', 'Enamorus',
			...
			'Palkia', 'Pheromosa', 'Porygon-Z', 'Rayquaza', 'Regieleki', 'Reshiram', 'Roserade', 'Salamence-Mega', 'Sceptile-Mega', 'Serperior', 'Shedinja', 'Sneasler',
	...
	},
	{
		...
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Non-Signature Z-Move Clause', 'Inaccurate Sleep Moves Clause'],
		banlist: [
			'Uber', 'AG', 'Moody', 'Power Construct', 'King\'s Rock',
			'Baton Pass', 'Last Respects', 'Quick Claw', 'Razor Fang', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
		],
	...
	},
	{
		...
		banlist: [
			...
			'Zacian-Crowned', 'Zekrom', 'Zeraora', 'Zygarde-50%', 'Arena Trap', 'Comatose', 'Contrary', 'Fur Coat', 'Gale Wings', 'Good as Gold', 'Explosive', 'Full Metal Body', 'Gorilla Tactics', 'Huge Power', 'Hydrophilic', 'Ice Scales', 'Illusion', 'Imposter', 'Innards Out',
			'Intrepid Sword', 'Light Power', 'Magic Bounce', 'Magnet Pull', 'Moody', 'Neutralizing Gas', 'Orichalcum Pulse', 'Parental Bond', 'Poison Heal', 'Psychic Prowess', 'Punching Prodigee', 'Pure Power', 'Shadow Tag', 'Simple', 'Speed Boost', 'Stakeout', 
			'Triage', 'Unburden', 'Water Bubble', 'Whiplash', 'Wonder Guard', 'King\'s Rock', 'Light Clay', 'Baton Pass', 'Electrify', 'Last Respects', 'Shed Tail', 'Tera Orb', 
		],
		unbanlist: ['Light of Ruin'],
	},
	{
		...
		banlist: [
			...
			'Arena Trap', 'Contrary', 'Gorilla Tactics', 'Hadron Engine', 'Huge Power', 'Hydrophilic', 'Illusion', 'Innards Out', 'Light Power', 'Magnet Pull', 'Moody', 'Neutralizing Gas', 'Orichalcum Pulse', 'Parental Bond', 'Psychic Prowess', 'Pure Power',
			...
			'Last Respects', 'Octolock', 'Rage Fist', 'Revival Blessing', 'Sappy Seed', 'Shed Tail', 'Shell Smash', 'Sleep Talk', 'V-create',
		],
		restricted: ['Arceus'],
		unbanlist: ['Light of Ruin'],
	...
	},
	{
		...
		banlist: [
			...
			'Kangaskhanite', 'Lucarionite Z', 'Mawilite', 'Medichamite', 'Pidgeotite', 'Red Orb', 
	...
	},
	{
		...
		banlist: [
			...
			'Koraidon', 'Kyogre', 'Kyurem', 'Kyurem-Black', 'Kyurem-White', 'Landorus-Incarnate', 'Lilligant-Hisui', 'Lucario-Mega', 'Lugia', 'Lunala', 'Magearna',
			...
			'Comatose', 'Last Respects', 'Rage Fist', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
		],
		restricted: [
	...
	},
	{
		...
		restricted: [
			...
			'Dragapult', 'Espathra', 'Eternatus', 'Flutter Mane', 'Garchomp-Mega-Z', 'Genesect', 'Gengar Mega', 'Giratina', 'Giratina-Origin', 'Groudon', 'Hawlucha', 'Ho-Oh', 'Iron Bundle', 'Kangaskhan-Mega', 'Kingambit',
	...
	},
	{
		...
		mod: 'gen9agoldenexperience',
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Camomons Mod', 'Non-Signature Z-Move Clause', 'Inaccurate Sleep Moves Clause'],
		banlist: [
			...
			'Baton Pass', 'Last Respects', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
		],
		unbanlist: ['Light of Ruin'],
	},
	{
		...
		banlist: [
			...
			'Serperior', 'Shaymin-Sky', 'Solgaleo', 'Spectrier', 'Ursaluna', 'Ursaluna-Bloodmoon', 'Tapu Koko', 'Ting-Lu', 'Xerneas', 'Xurkitree', 'Yveltal', 'Zacian', 
			'Zacian-Crowned', 'Zamazenta', 'Zamazenta-Crowned', 'Zekrom', 'Zoroark-Base', 'Zoroark-Hisui', 'Zygarde-Complete', 
			'Arena Trap', 'Damp Rock', 'Heat Rock', 'King\'s Rock', 'Razor Fang', 'Shadow Tag', 'Smooth Rock', 'Tera Orb', 
			'Baddy Bad', 'Baneful Bunker', 'Baton Pass', 'Belly Drum', 'Big Bang', 'Bolt Beak', 'Boomburst', 'Burning Bulwark', 'Ceaseless Edge', 'Clangorous Soul', 
	...
	},
	{
		...
		banlist: [
			'Arceus', 'Annihilape', 'Basculegion', 'Basculegion-F', 'Baxcalibur', 'Braviary-Hisui', 'Calyrex-Ice', 'Calyrex-Shadow', 'Chi-Yu', 'Chien-Pao', 'Conkeldurr', 'Darmanitan-Galar', 'Deoxys-Normal', 
			...
			'Necrozma-Dawn-Wings', 'Ogerpon-Hearthflame', 'Palafin', 'Palkia', 'Palkia-Origin', 'Pheromosa', 'Porygon-Z', 'Rayquaza', 'Reshiram', 'Roaring Moon', 'Shaymin-Sky', 'Solgaleo', 
			'Spectrier', 'Ursaluna-Bloodmoon', 'Urshifu-Single-Strike', 'Xerneas', 'Yveltal', 'Zacian', 'Zacian-Crowned', 'Zamazenta-Crowned',
			'Zekrom', 'Zygarde-50', 'Moody', 'Damp Rock', 'Icy Rock', 'King\'s Rock', 'Smooth Rock', 'Baton Pass', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
			'Last Respects',
		],
		unbanlist: ['Light of Ruin'],
		onValidateSet(set) {
	...
	},
	{
		...
		banlist: [
			...
			'Walking Wake', 'Weavile', 'Xerneas', 'Yanmega', 'Yveltal', 'Zacian', 'Zacian-Crowned', 'Zapdos-Galar', 'Zekrom', 'Zoroark-Hisui', 'Zygarde-50', 'Arena Trap', 'Magnet Pull', 'Moody', 'Neutralizing Gas',
			'Shadow Tag',
		...
		restricted: [
			'Comatose', 'Contrary', 'Fur Coat', 'Good as Gold', 'Gorilla Tactics', 'Huge Power', 'Hydrophilic', 'Ice Scales', 'Illusion', 'Imposter', 'Innards Out', 'Magic Bounce', 'Orichalcum Pulse',
			'Parental Bond', 'Poison Heal', 'Punching Prodigee', 'Pure Power', 'Quick Draw', 'Sand Veil', 'Simple', 'Snow Cloak', 'Speed Boost', 'Stakeout', 'Stench', 'Tinted Lens', 'Toxic Debris', 'Triage',
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50', 'Moody', 'Light Clay', 'Baton Pass', 'Last Respects', 'Revival Blessing', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
		],
		restricted: [
