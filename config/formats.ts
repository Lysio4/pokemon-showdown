...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Baton Pass', 'Last Respects', 'Quick Claw', 'Rage Fist', 'Razor Fang', 'Shed Tail', 'Tera Orb', 
		],
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50%', 'Zygarde-Complete', 'Commander', 'Eevium Z', 'Power Construct', 'Coaching', 'Dark Void', 'Rage Fist', 'Swagger', 'Tera Orb', 
		],
		unbanlist: ['Light of Ruin'],
	},
	...
	},
	{
		...
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Non-Signature Z-Move Clause'],
		banlist: [
			'Calyrex-Shadow', 'Koraidon', 'Miraidon', 'Moody', 'Beedrillite', 'Blazikenite', 'Centiskorchite Z', 'Garchompite Z', 'Glalitite',
			'Kangaskhanite', 'Lucarionite Z', 'Malamarite', 'Mawilite', 'Medichamite', 'Meowscaradite', 'Pidgeotite', 'Red Orb', 'Scolipite', 'Serperiorite', 'Scovillainite',
			'Slowbronite', 'Starminite', 'Victreebelite', 'Wigglytite', 'Yanmeganite', 
	...
	},
	{
		...
		banlist: [
			...
			'Comatose', 'Last Respects', 'Rage Fist', 'Shed Tail', 'Tera Orb', 
		],
		restricted: [
	...
	},
	{
		...
		banlist: [
			...
			'Baton Pass', 'Last Respects', 'Rage Fist', 'Shed Tail',
		],
		restricted: [
	...
	},
	{
		...
		banlist: [
			...
			'Baton Pass', 'Last Respects', 'Rage Fist', 'Shed Tail', 'Tera Orb', 
		],
		unbanlist: ['Light of Ruin'],
	},
	{
		...
		banlist: [
			...
			'Damp Rock', 'Heat Rock', 'King\'s Rock', 'Razor Fang', 'Smooth Rock', 'Tera Orb', 
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50', 'Moody', 'Damp Rock', 'Icy Rock', 'King\'s Rock', 'Smooth Rock', 'Baton Pass', 'Rage Fist', 'Shed Tail', 'Tera Orb', 
			'Last Respects',
		],
		unbanlist: ['Light of Ruin'],
		onValidateSet(set) {
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50', 'Moody', 'Light Clay', 'Baton Pass', 'Last Respects', 'Rage Fist', 'Revival Blessing', 'Shed Tail', 'Tera Orb', 
		],
		restricted: [
