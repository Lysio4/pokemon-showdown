...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50%', 'Zygarde-Complete', 'Commander', 'Eevium Z', 'Power Construct', 'Coaching', 'Dark Void', 'Rage Fist', 'Swagger',
		],
		unbanlist: ['Light of Ruin'],
	},
	...
	},
	{
		...
		banlist: [
			...
			'Strong Will', 'Triage', 'Unburden', 'Water Bubble', 'Wonder Guard', 'Wonder Skin', 'King\'s Rock', 'Light Clay', 'Baton Pass', 'Electrify', 'Last Respects', 'Rage Fist', 'Shed Tail',
		],
		unbanlist: ['Light of Ruin'],
	},
	{
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50', 'Moody', 'Damp Rock', 'Icy Rock', 'King\'s Rock', 'Smooth Rock', 'Baton Pass', 'Rage Fist', 'Shed Tail', 
			'Last Respects',
		],
		unbanlist: ['Light of Ruin'],
		onValidateSet(set) {
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50', 'Moody', 'Light Clay', 'Baton Pass', 'Last Respects', 'Rage Fist', 'Revival Blessing', 'Shed Tail',
		],
		restricted: [
	...
	},
	{
		...
		banlist: [
			...
			'Malignant Chain', 'Poison Fang', 'Rage Fist', 'Rage Powder', 'Skill Swap', 'Spicy Extract', 'Swagger', 'Toxic', 'Toxic Spikes',
		],
		unbanlist: ['Light of Ruin'],
	},
