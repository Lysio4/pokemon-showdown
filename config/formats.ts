...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Baton Pass', 'Last Respects', 'Quick Claw', 'Rage Fist', 'Razor Fang', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
		],
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50%', 'Zygarde-Complete', 'Commander', 'Shadow Tag', 'Eevium Z', 'Power Construct', 'Coaching', 'Dark Void', 'Rage Fist', 'Swagger', 'Tera Orb', 
		],
		unbanlist: ['Light of Ruin'],
	},
	...
	},
	{
		...
		banlist: [
			...
			'Contrary', 'Gorilla Tactics', 'Hadron Engine', 'Huge Power', 'Hydrophilic', 'Illusion', 'Innards Out', 'Light Power', 'Magnet Pull', 'Moody', 'Neutralizing Gas', 'Orichalcum Pulse', 'Parental Bond', 'Psychic Prowess', 'Pure Power',
	...
	},
	{
		...
		banlist: [
			...
			'Kangaskhanite', 'Lucarionite Z', 'Mawilite', 'Medichamite', 'Ogerponite', 'Pidgeotite', 'Red Orb', 
	...
	},
	{
		...
		restricted: [
			...
			'Salamence-Mega', 'Scream Tail', 'Serperior', 'Smeargle', 'Solgaleo', 'Spectrier', 'Swellow', 'Toxapex', 'Ursaluna', 'Ursaluna-Bloodmoon', 'Yveltal', 'Zacian', 'Zacian-Crowned', 'Zamazenta-Crowned',
	...
	},
	{
		...
		banlist: [
			...
			'Baton Pass', 'Last Respects', 'Rage Fist', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
		],
		unbanlist: ['Light of Ruin'],
	},
	{
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50', 'Moody', 'Damp Rock', 'Icy Rock', 'King\'s Rock', 'Smooth Rock', 'Baton Pass', 'Rage Fist', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
			'Last Respects',
		],
		unbanlist: ['Light of Ruin'],
		onValidateSet(set) {
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Zygarde-50', 'Moody', 'Light Clay', 'Baton Pass', 'Last Respects', 'Rage Fist', 'Revival Blessing', 'Shadow Tag', 'Shed Tail', 'Tera Orb', 
		],
		restricted: [
