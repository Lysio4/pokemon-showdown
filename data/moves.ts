...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	hornleech: {
		...
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, heal: 1, metronome: 1, drill: 1 },
		drain: [1, 2],
		target: "normal",
		type: "Grass",
		contestType: "Tough",
	...
	iciclespear: {
		...
		pp: 30,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, drill: 1 },
		multihit: [2, 5],
		target: "normal",
		type: "Ice",
		zMove: { basePower: 140 },
	...
	smackdown: {
		...
		condition: {
			...
			onStart(pokemon) {
				let applies = false;
				if (pokemon.hasType('Flying') || pokemon.hasAbility(['levitate', 'eelevate', 'healingecho'])) applies = true; // AGE modif
	...
	stomp: {
		...
		pp: 20,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, nonsky: 1, metronome: 1, minimize: 1, kick: 1 },
		secondary: {
			chance: 30,
			volatileStatus: 'flinch',
		},
	...
	piercingdart: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, slicing: 1, drill: 1 },
		onModifyMove(move, pokemon, target) {
	...
	ventilation: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, metronome: 1, wind: 1 },
		onPrepareHit(target, source) {
			this.attrLastMove('[still]');
			this.add('-anim', source, "Hurricane", target);
		},
