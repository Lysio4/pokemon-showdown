...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		ruleset: [
			...
			'Forme Clause', 'Sleep Moves Clause', 'Ability Clause = 2', 'OHKO Clause', 'Evasion Moves Clause', 'Dynamax Clause', 'CFZ Clause', 'Terastal Clause', 'Z-Move Clause',
		],
		banlist: [
	...
	},
	{
		...
		mod: 'gen9agoldenexperience',
		// searchShow: false,
		ruleset: ['Standard NatDex', 'STABmons Move Legality', '!Sleep Clause Mod', 'Sleep Moves Clause', 'Terastal Clause', 'Z-Move Clause'],
		banlist: [
			...
			'Eternatus', 'Flutter Mane', 'Garchomp', 'Gengar-Mega', 'Giratina', 'Giratina-Origin', 'Groudon', 'Gouging Fire', 'Ho-Oh', 'Iron Bundle', 
			...
			'Palkia-Origin', 'Porygon-Z', 'Pheromosa', 'Rayquaza', 'Reshiram', 'Salamence-Mega', 'Silvally', 'Snorlax', 'Solgaleo', 'Spectrier', 'Tapu Koko', 'Tapu Lele', 'Terapagos',
		...
		restricted: [
			...
			'Fillet Away', 'Final Gambit', 'Fishious Rend', 'Geomancy', 'Gigaton Hammer', 'Iceberg Polish', 'No Retreat', 'Revival Blessing', 'Shell Smash', 'Shift Gear', 
			'Thousand Arrows', 'Trick-or-Treat', 'Triple Arrows', 'V-create', 'Victory Dance', 'Zippy Zap', 
		],
	},
	{
		...
		mod: 'gen9agoldenexperience',
		ruleset: ['Standard NatDex', 'Terastal Clause', '!Sleep Clause Mod', 'Sleep Moves Clause', 'Godly Gift Mod', 'Mega Rayquaza Clause', 'Z-Move Clause'],
		banlist: [
	...
	},
	{
		...
		mod: 'gen9agoldenexperience',
		ruleset: ['Standard NatDex', 'Terastal Clause', 'Camomons Mod', 'Z-Move Clause'],
		banlist: [
	...
	},
	{
		...
		banlist: [
			...
			'Astral Barrage', 'Baneful Bunker', 'Baton Pass', 'Belly Drum', 'Bolt Beak', 'Boomburst', 'Burning Bulwark', 'Ceaseless Edge', 'Clangorous Soul', 'Double Iron Bash',
			'Dragon Energy', 'Electrify', 'Electro Shot', 'Eruption', 'Extreme Speed', 'Final Gambit', 'Fillet Away', 'Fishious Rend', 'Geomancy', 'Iceberg Polish', 'Jet Punch', 
			'Last Respects', 'Lumina Crash', 'No Retreat', 'Population Bomb', 'Quiver Dance', 'Revival Blessing', 'Rising Voltage', 'Salt Cure', 'Shed Tail', 'Shell Smash', 
			'Shift Gear', 'Surging Strikes', 'Tail Glow', 'Take Heart', 'Thousand Arrows', 'Transform', 'V-create', 'Victory Dance', 'Water Spout', 'Wicked Blow',
			'Power Construct', 'Regenerator > 2'
		],
		unbanlist: ['Battle Bond', 'Greninja-Bond', 'Light of Ruin'],
	},
	{
		...
		mod: 'pokebilitiesage',
		ruleset: ['Standard NatDex', 'Sleep Moves Clause', 'Terastal Clause', 'Z-Move Clause'],
		banlist: [
	...
	},
	{
		...
		ruleset: ['Standard', 'Sleep Moves Clause', '!Sleep Clause Mod', '!Evasion Items Clause', 'Z-Move Clause'],
		banlist: [
