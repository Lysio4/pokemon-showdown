...
interface MoveFlags {
	...
	// AGE
	drill?: 1; // Power and accuracy are multiplied by 1.3 when used by a Pokemon with the Ability Mighty Horn.
	kick?: 1; // Power is multiplied by 1.2 when used by a Pokemon with the Ability Striker.
	tail?: 1; // Gains +1 priority when used by a Pokemon with the Ability Whiplash.
}
