...
export const Scripts: ModdedBattleScriptsData = {
  ...
  init() {
    ...
    // dispelmagic
    this.modData('Learnsets', 'articunogalar').learnset.dispelmagic = ['9L1'];
    this.modData('Learnsets', 'misdreavus').learnset.dispelmagic = ['9L1'];
    this.modData('Learnsets', 'mismagius').learnset.dispelmagic = ['9L1'];
    this.modData('Learnsets', 'azelf').learnset.dispelmagic = ['9L1'];
    this.modData('Learnsets', 'meowstic').learnset.dispelmagic = ['9L1'];
    this.modData('Learnsets', 'meowsticf').learnset.dispelmagic = ['9L1'];
    this.modData('Learnsets', 'hoopa').learnset.dispelmagic = ['9L1'];
    this.modData('Learnsets', 'hatterene').learnset.dispelmagic = ['9L1'];

    // magicmissile
    this.modData('Learnsets', 'espeon').learnset.magicmissile = ['9L1'];
    this.modData('Learnsets', 'gardevoir').learnset.magicmissile = ['9L1'];
    ...
    this.modData('Learnsets', 'gothitelle').learnset.magicmissile = ['9L1'];
    this.modData('Learnsets', 'delphox').learnset.magicmissile = ['9L1'];
    this.modData('Learnsets', 'hoopa').learnset.magicmissile = ['9L1'];
    ...
    // prevailingwind
    this.modData('Learnsets', 'pidgeot').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'clefable').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'scyther').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'pinsir').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'gyarados').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'aerodactyl').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'articuno').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'articunogalar').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'zapdos').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'zapdosgalar').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'moltres').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'moltresgalar').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'dragonite').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'noctowl').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'togetic').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'natu').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'xatu').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'hoppip').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'skiploom').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'jumpluff').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'scizor').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'skarmory').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'blaziken').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'swellow').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'pelipper').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'altaria').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'castform').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'chimecho').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'empoleon').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'staraptor').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'drifblim').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'togekiss').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'gliscor').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'gallade').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'shaymin').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'emolga').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'hydreigon').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'volcarona').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'talonflame').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'vivillon').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'aromatisse').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'hawlucha').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'noivern').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'decidueye').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'decidueyehisui').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'toucannon').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'drampa').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'corviknight').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'flapple').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'sandaconda').learnset.prevailingwind = ['9L1'];
    this.modData('Learnsets', 'cramorant').learnset.prevailingwind = ['9L1'];
    ...
    // swarming
    this.modData('Learnsets', 'parasect').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'porygon').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'mewtwo').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'yanma').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'deoxys').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'kricketune').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'accelgor').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'vikavolt').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'silvally').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'scizorgalar').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'annoyog').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'baalzebutis').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'snoxin').learnset.swarming = ['9M'];
    this.modData('Learnsets', 'magroach').learnset.swarming = ['9M'];
    ...
    this.modData('Learnsets', 'tapubulu').learnset.natureswrath = ['9M'];
    ...
    this.modData('Learnsets', 'houndoom').learnset.flamingsphere = ['9M'];
    ...
    this.modData('Learnsets', 'houndoom').learnset.fireball = ['9M'];
    ...
    this.modData('Learnsets', 'omanyte').learnset.highwater = ['9M'];
    this.modData('Learnsets', 'omastar').learnset.highwater = ['9M'];
    ...
    this.modData('Learnsets', 'mudkip').learnset.highwater = ['9M'];
    this.modData('Learnsets', 'marshtomp').learnset.highwater = ['9M'];
    this.modData('Learnsets', 'swampert').learnset.highwater = ['9M'];
    this.modData('Learnsets', 'oshawott').learnset.highwater = ['9M'];
    this.modData('Learnsets', 'dewott').learnset.highwater = ['9M'];
    this.modData('Learnsets', 'samurott').learnset.highwater = ['9M'];
    this.modData('Learnsets', 'samurotthisui').learnset.highwater = ['9M'];
    ...
    this.modData('Learnsets', 'relicanth').learnset.roguewave = ['9L1'];
    ...
    this.modData('Learnsets', 'thundurus').learnset.parallelcircuit = ['9M'];
    this.modData('Learnsets', 'tapukoko').learnset.parallelcircuit = ['9M'];
    ...
    this.modData('Learnsets', 'omanyte').learnset.landslide = ['9M'];
    this.modData('Learnsets', 'omastar').learnset.landslide = ['9M'];
    ...
    this.modData('Learnsets', 'torkoal').learnset.landslide = ['9M'];
    this.modData('Learnsets', 'torterra').learnset.landslide = ['9M'];
    this.modData('Learnsets', 'gible').learnset.landslide = ['9M'];
    this.modData('Learnsets', 'gabite').learnset.landslide = ['9M'];
    this.modData('Learnsets', 'garchomp').learnset.landslide = ['9M'];
    ...
    this.modData('Learnsets', 'excadrill').learnset.landslide = ['9M'];
    this.modData('Learnsets', 'landorus').learnset.landslide = ['9M'];
    ...
    // downdraft
    this.modData('Learnsets', 'articuno').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'articunogalar').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'zapdos').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'zapdosgalar').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'moltres').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'moltresgalar').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'dragonite').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'mew').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'noctowl').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'lugia').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'hooh').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'shiftry').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'swellow').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'altaria').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'salamence').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'latias').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'latios').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'rayquaza').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'staraptor').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'drifblim').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'unfezant').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'unfezantf').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'archeops').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'braviary').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'braviaryhisui').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'tornadus').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'landorus').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'talonflame').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'noivern').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'celesteela').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'corviknight').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'ironjugulis').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'admistral').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'medidragon').learnset.downdraft = ['9M'];
    this.modData('Learnsets', 'cymadalea').learnset.downdraft = ['9M'];
    ...
    this.modData('Learnsets', 'tauros').learnset.golemstrike = ['9M'];
    ...
    this.modData('Learnsets', 'landorus').learnset.golemstrike = ['9M'];
    ...
    this.modData('Learnsets', 'tapubulu').learnset.golemstrike = ['9M'];
    ...
    this.modData('Learnsets', 'guzzlord').learnset.golemstrike = ['9M'];
    ...
    this.modData('Learnsets', 'tapufini').learnset.condensate = ['9L1'];
    this.modData('Learnsets', 'glastrier').learnset.condensate = ['9L1'];
    this.modData('Learnsets', 'calyrexice').learnset.condensate = ['9L1'];

    // chillblain
    this.modData('Learnsets', 'sandshrewalola').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'sandslashalola').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'vulpixalola').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'ninetalesalola').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'dewgong').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'cloyster').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'mrmimegalar').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'jynx').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'lapras').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'articuno').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'sneasel').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'swinub').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'piloswine').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'delibird').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'smoochum').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'mew').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'snorunt').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'glalie').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'spheal').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'sealeo').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'walrein').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'regice').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'snover').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'abomasnow').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'weavile').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'glaceon').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'mamoswine').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'froslass').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'rotom').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'castform').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'darumakagalar').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'darmanitangalar').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'vanillite').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'vanillish').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'vanilluxe').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'cubchoo').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'beartic').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'cryogonal').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'kyurem').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'amaura').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'aurorus').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'bergmite').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'avalugg').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'crabominable').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'mrrime').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'snom').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'frosmoth').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'arceus').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'silvally').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'eiscue').learnset.chillblain = ['9M'];
    this.modData('Learnsets', 'arctozolt').learnset.chillblain = ['9M'];
    ...
    // contrariety
    this.modData('Learnsets', 'houndour').learnset.contrariety = ['9M'];
    this.modData('Learnsets', 'houndoom').learnset.contrariety = ['9M'];
    ...
    this.modData('Learnsets', 'malamar').learnset.contrariety = ['9M'];
    this.modData('Learnsets', 'rowlet').learnset.contrariety = ['9M'];
    this.modData('Learnsets', 'guzzlord').learnset.contrariety = ['9M'];
    ...
    // sneakyassault
    this.modData('Learnsets', 'rattataalola').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'raticatealola').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'meowth').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'persian').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'meowthalola').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'persianalola').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'meowthgalar').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'perrserker').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'gligar').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'sneasel').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'houndour').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'houndoom').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'ninjask').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'zangoose').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'absol').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'mothim').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'luxray').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'drapion').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'weavile').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'gliscor').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'oshawott').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'dewott').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'samurott').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'samurotthisui').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'purrloin').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'liepard').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'zorua').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'zoroark').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'greninja').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'greninjabond').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'kartana').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'zeraora').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'zarude').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'zarudedada').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'meowscarada').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'lokix').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'maushold').learnset.sneakyassault = ['9M'];
    this.modData('Learnsets', 'slendawful').learnset.sneakyassault = ['9M'];
    ...
    this.modData('Learnsets', 'tapufini').learnset.mercuryshot = ['9M'];
    ...
    this.modData('Learnsets', 'blastoise').learnset.steelbeam = ['9M'];
    ...
    this.modData('Learnsets', 'pidgeot').learnset.nastyplot = ['9L1'];
    this.modData('Learnsets', 'spearow').learnset.bravebird = ['9L1'];
    this.modData('Learnsets', 'fearow').learnset.bravebird = ['9L1'];
    this.modData('Learnsets', 'fearow').learnset.hyperdrill = ['9L1'];
    ...
    this.modData('Learnsets', 'flareon').learnset.burningbulwark = ['9L1'];
    ...
    this.modData('Learnsets', 'loudred').learnset.sonicboom = ['9L1'];
    this.modData('Learnsets', 'exploud').learnset.bigbang = ['9L1'];
    this.modData('Learnsets', 'exploud').learnset.sonicboom = ['9L1'];
    ...
    this.modData('Learnsets', 'walrein').learnset.freezedry = ['9L1'];
    this.modData('Learnsets', 'walrein').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'huntail').learnset.fissure = ['9L1'];
    this.modData('Learnsets', 'huntail').learnset.powerwhip = ['9L1'];
    this.modData('Learnsets', 'huntail').learnset.rockslide = ['9L1'];
    ...
    this.modData('Learnsets', 'garchomp').learnset.aquacutter = ['9L1'];
    this.modData('Learnsets', 'garchomp').learnset.temperflare = ['9L1'];
    ...
    this.modData('Learnsets', 'rotomfan').learnset.tailwind = ['9L1'];
    ...
    this.modData('Learnsets', 'samurott').learnset.shellsmash = ['9L1'];
    ...
    this.modData('Learnsets', 'simisage').learnset.frenzyplant = ['9L1'];
    this.modData('Learnsets', 'simisage').learnset.powerwhip = ['9L1'];
    this.modData('Learnsets', 'simisage').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'simisage').learnset.uturn = ['9L1'];
    this.modData('Learnsets', 'simisear').learnset.blastburn = ['9L1'];
    this.modData('Learnsets', 'simisear').learnset.encore = ['9L1'];
    this.modData('Learnsets', 'simisear').learnset.partingshot = ['9L1'];
    this.modData('Learnsets', 'simisear').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'simipour').learnset.encore = ['9L1'];
    this.modData('Learnsets', 'simipour').learnset.hydrocannon = ['9L1'];
    ...
    this.modData('Learnsets', 'zebstrika').learnset.superpower = ['9L1'];
    this.modData('Learnsets', 'gigalith').learnset.rockwrecker = ['9L1'];
    ...
    this.modData('Learnsets', 'gigalith').learnset.trickroom = ['9L1'];
    ...
    this.modData('Learnsets', 'scolipede').learnset.coil = ['9L1'];
    this.modData('Learnsets', 'scolipede').learnset.powertrip = ['9L1'];
    this.modData('Learnsets', 'scolipede').learnset.stringshot = ['9L1'];
    ...
    this.modData('Learnsets', 'zoroarkhisui').learnset.chillblain = ['9M'];
    ...
    this.modData('Learnsets', 'eelektross').learnset.thunderclap = ['9L1'];
    ...
    this.modData('Learnsets', 'mienshao').learnset.breakingswipe = ['9L1'];
    this.modData('Learnsets', 'mienshao').learnset.courtchange = ['9L1'];
    this.modData('Learnsets', 'mienshao').learnset.dracometeor = ['9L1'];
    this.modData('Learnsets', 'mienshao').learnset.dragonpulse = ['9L1'];
    this.modData('Learnsets', 'mienshao').learnset.icywind = ['9L1'];
    ...
    this.modData('Learnsets', 'meowsticf').learnset.moonblast = ['9L1'];
    this.modData('Learnsets', 'clawitzer').learnset.dracometeor = ['9M'];
    this.modData('Learnsets', 'heliolisk').learnset.earthpower = ['9L1'];
    this.modData('Learnsets', 'heliolisk').learnset.electroshot = ['9L1'];
    ...
    this.modData('Learnsets', 'tsareena').learnset.closecombat = ['9L1'];
    this.modData('Learnsets', 'tsareena').learnset.icespinner = ['9L1'];
    ...
    this.modData('Learnsets', 'tapukoko').learnset.supercellslam = ['9M'];
    ...
    this.modData('Learnsets', 'guzzlord').learnset.jawlock = ['9L1'];
    this.modData('Learnsets', 'guzzlord').learnset.partingshot = ['9M'];
    this.modData('Learnsets', 'guzzlord').learnset.slackoff = ['9M'];
    this.modData('Learnsets', 'guzzlord').learnset.spikes = ['9M'];
    this.modData('Learnsets', 'guzzlord').learnset.toxicspikes = ['9M'];
    ...
    this.modData('Learnsets', 'enamorus').learnset.acrobatics = ['9L1'];
    this.modData('Learnsets', 'enamorus').learnset.defog = ['9L1'];
    this.modData('Learnsets', 'enamorus').learnset.hammerarm = ['9L1'];
    this.modData('Learnsets', 'enamorus').learnset.knockoff = ['9L1'];
    this.modData('Learnsets', 'enamorus').learnset.moonlight = ['9L1'];
    this.modData('Learnsets', 'enamorus').learnset.nastyplot = ['9L1'];
    ...
    this.modData('Learnsets', 'cetitan').learnset.mountaingale = ['9L1'];
    ...
    this.modData('Learnsets', 'okidogi').learnset.crazedpunch = ['9L1'];
    this.modData('Learnsets', 'munkidori').learnset.dirtyheadshot = ['9L1'];
    this.modData('Learnsets', 'fezandipiti').learnset.cruelfeather = ['9L1'];
    this.modData('Learnsets', 'fezandipiti').learnset.defog = ['9M'];
    this.modData('Learnsets', 'fezandipiti').learnset.knockoff = ['9M'];
