export const Items: import('../sim/dex-items').ItemDataTable = {
	...
	tapuniumz: {
		...
		itemUser: ["Tapu Koko", "Tapu Lele", "Tapu Bulu", "Tapu Fini", "Tapu Wala"],
		num: 801,
		gen: 7,
		isNonstandard: "Past",
	},
	...
	galaslowbronite: {
		name: "Galaslowbronite",
		spritenum: 620,
		megaStone: { "Slowbro-Galar": "Slowbro-Galar-Mega" },
		...
		num: -9,
		gen: 9,
		desc: "If held by a Slowbro-Galar, this item allows it to Mega Evolve in battle.",
		isNonstandard: "Custom",
	},
	typhlosionite: {
		name: "Typhlosionite",
	...
	hisutyphlosionite: {
		name: "Hisutyphlosionite",
		spritenum: 586,
		megaStone: { "Typhlosion-Hisui": "Typhlosion-Hisui-Mega" },
		...
		num: -11,
		gen: 9,
		desc: "If held by a Typhlosion-Hisui, this item allows it to Mega Evolve in battle.",
		isNonstandard: "Custom",
	},
	noctowlite: {
		name: "Noctowlite",
	...
	galascizorite: {
		name: "Galascizorite",
		spritenum: 605,
		megaStone: { "Scizor-Galar": "Scizor-Galar-Mega" },
		itemUser: ["Scizor-Galar"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
		num: -14,
		gen: 9,
		desc: "If held by a Scizor-Galar, this item allows it to Mega Evolve in battle.",
		isNonstandard: "Custom",
	},
	flygonite: {
		name: "Flygonite",
	...
	whiscashite: {
		name: "Whiscashite",
		spritenum: 578,
		megaStone: { "Whiscash": "Whiscash-Mega" },
		itemUser: ["Whiscash"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	castformite: {
		...
		spritenum: 578,
		megaStone: {
			"Castform": "Castform-Mega",
			"Castform-Rainy": "Castform-Mega",
			"Castform-Snowy": "Castform-Mega",
			"Castform-Sunny": "Castform-Mega",
		},
		itemUser: ["Castform", "Castform-Rainy", "Castform-Snowy", "Castform-Sunny"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
		num: -18,
	...
	skuntankite: {
		name: "Skuntankite",
		spritenum: 578,
		megaStone: { "Skuntank": "Skuntank-Mega" },
		itemUser: ["Skuntank"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	gigalite: {
		name: "Gigalite",
		spritenum: 607,
		megaStone: { "Gigalith": "Gigalith-Mega" },
		itemUser: ["Gigalith"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	hisuzoroarkite: {
		...
		num: -25,
		gen: 9,
		desc: "If held by a Zoroark-Hisui, this item allows it to Mega Evolve in battle.",
		isNonstandard: "Custom",
	},
	sawsbuckite: {
		name: "Sawsbuckite",
		spritenum: 613,
		megaStone: {
			"Sawsbuck": "Sawsbuck-Spring-Mega",
			"Sawsbuck-Summer": "Sawsbuck-Summer-Mega",
			"Sawsbuck-Autumn": "Sawsbuck-Autumn-Mega",
			"Sawsbuck-Winter": "Sawsbuck-Winter-Mega",
		},
	...
	deciduitex: {
		name: "Deciduite X",
		spritenum: 578,
		megaStone: { "Decidueye": "Decidueye-Mega-X" },
		itemUser: ["Decidueye"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	deciduitey: {
		name: "Deciduite Y",
		spritenum: 578,
		megaStone: { "Decidueye": "Decidueye-Mega-Y" },
		itemUser: ["Decidueye"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	ribombinite: {
		name: "Ribombinite",
		spritenum: 578,
		megaStone: { "Ribombee": "Ribombee-Mega" },
		itemUser: ["Ribombee"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	cramorantite: {
		name: "Cramorantite",
		megaStone: {
			"Cramorant": "Cramorant-Mega",
			"Cramorant-Gulping": "Cramorant-Mega",
			"Cramorant-Gorging": "Cramorant-Mega",
		},
		itemUser: ["Cramorant", "Cramorant-Gulping", "Cramorant-Gorging"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
		num: -38,
	...
	centiskorchitex: {
		...
		spritenum: 578,
		megaStone: { "Centiskorch": "Centiskorch-Mega-X" },
	...
	centiskorchitey: {
		...
		spritenum: 578,
		megaStone: { "Centiskorch": "Centiskorch-Mega-Y" },
		itemUser: ["Centiskorch"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	baskironite: {
		name: "Baskironite",
		spritenum: 578,
		megaStone: { "Baskiron": "Baskiron-Mega" },
		itemUser: ["Baskiron"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	terreptilite: {
		name: "Terreptilite",
		spritenum: 578,
		megaStone: { "Terreptile": "Terreptile-Mega" },
		itemUser: ["Terreptile"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	infarmatemite: {
		name: "Infarmatemite",
		spritenum: 578,
		megaStone: { "Infarmatem": "Infarmatem-Mega" },
		itemUser: ["Infarmatem"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	hisudecidiumz: {
		...
		spritenum: 650,
		onTakeItem: false,
		zMove: "Furious Arrow Raid",
		zMoveFrom: "Triple Arrows",
		itemUser: ["Decidueye-Hisui"],
		num: -56,
		gen: 9,
		shortDesc: "If held by a Decidueye-Hisui with Triple Arrows, it can use Furious Arrow Raid.",
		isNonstandard: "Custom",
	},
	overqwiliumz: {
		name: "Overqwilium Z",
