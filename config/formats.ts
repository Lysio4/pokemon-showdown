...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Strong Will', 'Triage', 'Unburden', 'Water Bubble', 'Wonder Guard', 'Wonder Skin', 'King\'s Rock', 'Light Clay', 'Baton Pass', 'Electrify', 'Last Respects', 'Rage Fist', 'Shed Tail', 'Tera Orb', 
		],
		unbanlist: ['Light of Ruin'],
	},
	{
	...
	},
	{
		...
		banlist: [
			...
			'Starminite', 'Victreebelite', 'Wigglytite', 'Yanmeganite', 
	...
	},
	{
		...
		banlist: [
			...
			'Last Respects', 'Rage Fist', 'Shed Tail', 'Tera Orb', 
		],
		restricted: [
