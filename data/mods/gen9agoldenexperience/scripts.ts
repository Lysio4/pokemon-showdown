export const Scripts: ModdedBattleScriptsData = {
  ...
  actions: {
    ...
    hitStepMoveHitLoop(targets: Pokemon[], pokemon: Pokemon, move: ActiveMove) { // Temporary name
      ...
      if ((move.recoil || (move.id === 'chloroblast' && !pokemon.hasAbility('explosive'))) && move.totalDamage) {
        const hpBeforeRecoil = pokemon.hp;
  ...
  init() {
    ...
    this.modData('Learnsets', 'moltres').learnset.fireball = ['9M'];
    ...
    this.modData('Learnsets', 'regigigas').learnset.landslide = ['9M'];
    ...
    this.modData('Learnsets', 'zapdos').learnset.downdraft = ['9L1'];
    this.modData('Learnsets', 'zapdosgalar').learnset.downdraft = ['9L1'];
    ...
    this.modData('Learnsets', 'necrozmaduskmane').learnset.blackflash = ['9M'];
    this.modData('Learnsets', 'necrozmadawnwings').learnset.blackflash = ['9M'];
    ...
    this.modData('Learnsets', 'venusaur').learnset.sludgewave = ['9L1']; // Champions addition
    this.modData('Learnsets', 'charizard').learnset.dracometeor = ['9M'];
    this.modData('Learnsets', 'blastoise').learnset.heavyslam = ['9L1'];
    this.modData('Learnsets', 'blastoise').learnset.scaredyshell = ['9L1'];
    this.modData('Learnsets', 'blastoise').learnset.ironhead = ['9L1']; // Champions addition
    this.modData('Learnsets', 'butterfree').learnset.befuddlepowder = ['9L1'];
    this.modData('Learnsets', 'beedrill').learnset.piercingdart = ['9L1'];
    this.modData('Learnsets', 'beedrill').learnset.bugbuzz = ['9L1']; // Champions addition
    this.modData('Learnsets', 'beedrill').learnset.crosspoison = ['9L1']; // Champions addition
    this.modData('Learnsets', 'beedrill').learnset.dualwingbeat = ['9L1']; // Champions addition
    this.modData('Learnsets', 'beedrill').learnset.lunge = ['9L1']; // Champions addition
    this.modData('Learnsets', 'beedrill').learnset.pollenpuff = ['9L1']; // Champions addition
    this.modData('Learnsets', 'beedrill').learnset.skittersmack = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'raichu').learnset.dazzlinggleam = ['9L1']; // Champions addition
    this.modData('Learnsets', 'raichu').learnset.drainpunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'raichualola').learnset.dazzlinggleam = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'clefable').learnset.airslash = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'wigglytuff').learnset.fakeout = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'meowthgalar').learnset.bulkup = ['9L1']; // ZA addition
    this.modData('Learnsets', 'persian').learnset.crushclaw = ['9L1'];
    this.modData('Learnsets', 'persian').learnset.spikes = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'persianalola').learnset.toxicspikes = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'mankey').learnset.stormthrow = ['9L1']; // ZA addition
    this.modData('Learnsets', 'primeape').learnset.stormthrow = ['9L1']; // ZA addition
    this.modData('Learnsets', 'primeape').learnset.knockoff = ['9L1']; // ZA addition
    this.modData('Learnsets', 'arcanine').learnset.swordsdance = ['9L1'];
    this.modData('Learnsets', 'arcaninehisui').learnset.swordsdance = ['9L1'];
    this.modData('Learnsets', 'arcaninehisui').learnset.burnup = ['9L1']; // Champions addition
    this.modData('Learnsets', 'arcaninehisui').learnset.irontail = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'machamp').learnset.drainpunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'machamp').learnset.stormthrow = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'victreebel').learnset.toxicspikes = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'slowbrogalar').learnset.toxicspikes = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'starmie').learnset.ancientpower = ['9L1']; // Champions addition
    this.modData('Learnsets', 'starmie').learnset.bulkup = ['9L1']; // Champions addition
    this.modData('Learnsets', 'starmie').learnset.zenheadbutt = ['9L1']; // Champions addition
    this.modData('Learnsets', 'starmie').learnset.aquajet = ['9L1']; // Champions addition
    this.modData('Learnsets', 'starmie').learnset.liquidation = ['9L1']; // Champions addition
    this.modData('Learnsets', 'starmie').learnset.selfdestruct = ['9L1']; // Champions addition
    this.modData('Learnsets', 'starmie').learnset.safeguard = ['9L1']; // Champions addition
    this.modData('Learnsets', 'starmie').learnset.chargebeam = ['9L1']; // Champions addition
    this.modData('Learnsets', 'starmie').learnset.icespinner = ['9L1']; // Champions addition
    this.modData('Learnsets', 'pinsir').learnset.megahorn = ['9L1'];
    this.modData('Learnsets', 'pinsir').learnset.aerialace = ['9L1']; // Champions addition
    this.modData('Learnsets', 'pinsir').learnset.hardpress = ['9L1']; // Champions addition
    this.modData('Learnsets', 'pinsir').learnset.lunge = ['9L1']; // Champions addition
    this.modData('Learnsets', 'taurospaldeacombat').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'taurospaldeacombat').learnset.irontail = ['9L1']; // Champions addition
    this.modData('Learnsets', 'taurospaldeacombat').learnset.megahorn = ['9L1']; // Champions addition
    this.modData('Learnsets', 'taurospaldeaaqua').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'taurospaldeaaqua').learnset.irontail = ['9L1']; // Champions addition
    this.modData('Learnsets', 'taurospaldeaaqua').learnset.megahorn = ['9L1']; // Champions addition
    this.modData('Learnsets', 'taurospaldeablaze').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'taurospaldeablaze').learnset.irontail = ['9L1']; // Champions addition
    this.modData('Learnsets', 'taurospaldeablaze').learnset.megahorn = ['9L1']; // Champions addition
    this.modData('Learnsets', 'gyarados').learnset.dragonrush = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'porygon').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'dragonite').learnset.whirlwind = ['9L1']; // Champions addition
    this.modData('Learnsets', 'mewtwo').learnset.vacuumwave = ['9L1']; // ZA addition

    // Gen 2:
    this.modData('Learnsets', 'meganium').learnset.dazzlinggleam = ['9L1']; // Champions addition
    this.modData('Learnsets', 'meganium').learnset.earthpower = ['9L1']; // Champions addition
    this.modData('Learnsets', 'meganium').learnset.leafblade = ['9L1']; // Champions addition
    this.modData('Learnsets', 'meganium').learnset.pollenpuff = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'typhlosionhisui').learnset.mysticalfire = ['9L1']; // Champions addition
    this.modData('Learnsets', 'feraligatr').learnset.dracometeor = ['9M'];
    ...
    this.modData('Learnsets', 'ariados').learnset.firstimpression = ['9L1']; // Champions addition
    this.modData('Learnsets', 'ariados').learnset.psychicfangs = ['9L1']; // Champions addition
    this.modData('Learnsets', 'crobat').learnset.knockoff = ['9L1']; // ZA addition
    this.modData('Learnsets', 'crobat').learnset.psychicfangs = ['9L1']; // ZA addition
    this.modData('Learnsets', 'lanturn').learnset.tailglow = ['9L1'];
    this.modData('Learnsets', 'ampharos').learnset.dracometeor = ['9M'];
    this.modData('Learnsets', 'ampharos').learnset.milkdrink = ['9L1'];
    this.modData('Learnsets', 'ampharos').learnset.paraboliccharge = ['9L1']; // Champions addition
    this.modData('Learnsets', 'ampharos').learnset.risingvoltage = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'umbreon').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'umbreon').learnset.uturn = ['9L1'];
    this.modData('Learnsets', 'murkrow').learnset.partingshot = ['9L1'];
    this.modData('Learnsets', 'slowkinggalar').learnset.corrosiveacid = ['9L1'];
    this.modData('Learnsets', 'forretress').learnset.steelroller = ['9L1']; // Champions addition
    this.modData('Learnsets', 'scizor').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'skarmory').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    // Gen 3:
    this.modData('Learnsets', 'sceptile').learnset.dracometeor = ['9M'];
    this.modData('Learnsets', 'sceptile').learnset.earthpower = ['9M'];
    this.modData('Learnsets', 'sceptile').learnset.uturn = ['9M'];
    this.modData('Learnsets', 'sceptile').learnset.airslash = ['9M'];
    ...
    this.modData('Learnsets', 'sableye').learnset.nightslash = ['9L1']; // Champions addition
    this.modData('Learnsets', 'mawile').learnset.dazzlinggleam = ['9L1']; // ZA addition
    this.modData('Learnsets', 'aggron').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'medicham').learnset.agility = ['9L1']; // Champions addition
    this.modData('Learnsets', 'medicham').learnset.blazekick = ['9L1']; // Champions addition
    this.modData('Learnsets', 'medicham').learnset.coaching = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'camerupt').learnset.energyball = ['9L1'];
    this.modData('Learnsets', 'camerupt').learnset.burningjealousy = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'banette').learnset.zenheadbutt = ['9L1']; // Champions addition
    this.modData('Learnsets', 'chimecho').learnset.teleport = ['9L1'];
    this.modData('Learnsets', 'chimecho').learnset.boomburst = ['9L1']; // Champions addition
    this.modData('Learnsets', 'chimecho').learnset.flashcannon = ['9L1']; // Champions addition
    this.modData('Learnsets', 'chimecho').learnset.calmingbell = ['9L1']; 
    this.modData('Learnsets', 'absol').learnset.sacredsword = ['9L1']; 
    this.modData('Learnsets', 'absol').learnset.phantomforce = ['9L1']; // Champions addition
    this.modData('Learnsets', 'absol').learnset.shadowsneak = ['9L1']; // Champions addition
    this.modData('Learnsets', 'absol').learnset.trailblaze = ['9L1']; // Champions addition
    this.modData('Learnsets', 'glalie').learnset.rapidspin = ['9L1'];
    this.modData('Learnsets', 'glalie').learnset.hypervoice = ['9L1'];
    this.modData('Learnsets', 'glalie').learnset.boomburst = ['9L1'];
    ...
    this.modData('Learnsets', 'metang').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'metagross').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'staraptor').learnset.bulkup = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'roserade').learnset.trailblaze = ['9L1']; // Champions addition
    this.modData('Learnsets', 'rampardos').learnset.wildcharge = ['9L1'];
    this.modData('Learnsets', 'rampardos').learnset.submission = ['9L1'];
    this.modData('Learnsets', 'rampardos').learnset.meteorbeam = ['9L1']; // Champions addition
    this.modData('Learnsets', 'bastiodon').learnset.steelroller = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'wormadamsandy').learnset.spikes = ['9L1'];
    ...
    this.modData('Learnsets', 'ambipom').learnset.quickattack = ['9L1'];
    ...
    this.modData('Learnsets', 'lopunny').learnset.cottonguard = ['9L1']; // Champions addition
    this.modData('Learnsets', 'lopunny').learnset.dynamicpunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'lopunny').learnset.machpunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'lopunny').learnset.swordsdance = ['9L1']; // Champions addition
    this.modData('Learnsets', 'lopunny').learnset.trailblaze = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'croagunk').learnset.earthpower = ['9L1'];
    this.modData('Learnsets', 'toxicroak').learnset.earthpower = ['9L1'];
    ...
    this.modData('Learnsets', 'abomasnow').learnset.icehammer = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'yanmega').learnset.dracometeor = ['9M'];
    ...
    this.modData('Learnsets', 'glaceon').learnset.uturn = ['9L1'];
    this.modData('Learnsets', 'gliscor').learnset.pinmissile = ['9L1']; // Champions addition
    this.modData('Learnsets', 'gliscor').learnset.powerwhip = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'porygonz').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'gallade').learnset.icebeam = ['9L1'];
    this.modData('Learnsets', 'gallade').learnset.focusenergy = ['9L1'];
    ...
    this.modData('Learnsets', 'froslass').learnset.nastyplot = ['9L1']; // Champions addition
    this.modData('Learnsets', 'froslass').learnset.phantomforce = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'dialga').learnset.recover = ['9L1'];
    this.modData('Learnsets', 'dialga').learnset.spikes = ['9L1'];
    ...
    this.modData('Learnsets', 'regigigas').learnset.stealthrock = ['9L1'];
    ...
    this.modData('Learnsets', 'giratina').learnset.roost = ['9L1'];
    this.modData('Learnsets', 'cresselia').learnset.recover = ['9L1'];
    this.modData('Learnsets', 'phione').learnset.calmmind = ['9L1'];
    this.modData('Learnsets', 'phione').learnset.moonblast = ['9L1'];
    this.modData('Learnsets', 'manaphy').learnset.moonblast = ['9L1'];
    this.modData('Learnsets', 'darkrai').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'darkrai').learnset.shadowsneak = ['9L1']; // ZA addition
    this.modData('Learnsets', 'darkrai').learnset.iciclespear = ['9L1']; // ZA addition
    this.modData('Learnsets', 'shaymin').learnset.recover = ['9L1'];
    this.modData('Learnsets', 'arceus').learnset.mysticalfire = ['9L1'];

    // Gen 5:
    this.modData('Learnsets', 'serperior').learnset.hurricane = ['9L1'];
    this.modData('Learnsets', 'emboar').learnset.submission = ['9L1'];
    this.modData('Learnsets', 'emboar').learnset.scorchingsands = ['9L1']; // Champions addition
    this.modData('Learnsets', 'emboar').learnset.stormthrow = ['9L1']; // Champions addition
    this.modData('Learnsets', 'emboar').learnset.solarblade = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'watchog').learnset.doubleedge = ['9L1']; // Champions addition
    this.modData('Learnsets', 'watchog').learnset.endure = ['9L1']; // Champions addition
    this.modData('Learnsets', 'watchog').learnset.trailblaze = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'liepard').learnset.crunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'liepard').learnset.firefang = ['9L1']; // Champions addition
    this.modData('Learnsets', 'liepard').learnset.icefang = ['9L1']; // Champions addition
    this.modData('Learnsets', 'liepard').learnset.psychicfangs = ['9L1']; // Champions addition
    this.modData('Learnsets', 'liepard').learnset.thunderfang = ['9L1']; // Champions addition
    this.modData('Learnsets', 'liepard').learnset.trailblaze = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'simisage').learnset.belch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisage').learnset.endure = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisage').learnset.fakeout = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisage').learnset.grassyglide = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisage').learnset.solarblade = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisage').learnset.stuffcheeks = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisage').learnset.trailblaze = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'simisear').learnset.blazekick = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisear').learnset.burningjealousy = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisear').learnset.endure = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisear').learnset.fakeout = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisear').learnset.scorchingsands = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisear').learnset.stuffcheeks = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simisear').learnset.temperflare = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'simipour').learnset.endure = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simipour').learnset.fakeout = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simipour').learnset.flipturn = ['9L1']; // Champions addition
    this.modData('Learnsets', 'simipour').learnset.liquidation = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'sawk').learnset.swordsdance = ['9L1']; // ZA addition
    this.modData('Learnsets', 'sawk').learnset.blazekick = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'krookodile').learnset.fissure = ['9L1']; // Champions addition
    this.modData('Learnsets', 'krookodile').learnset.ironhead = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'cofagrigus').learnset.partingshot = ['9L1'];
    this.modData('Learnsets', 'cofagrigus').learnset.stealthrock = ['9L1'];
    this.modData('Learnsets', 'cofagrigus').learnset.gigadrain = ['9L1']; // Champions addition
    this.modData('Learnsets', 'cofagrigus').learnset.selfdestruct = ['9L1']; // Champions addition
    this.modData('Learnsets', 'trubbish').learnset.poisonjab = ['9L1']; // Champions addition
    this.modData('Learnsets', 'garbodor').learnset.ancientpower = ['9L1']; // Champions addition
    this.modData('Learnsets', 'garbodor').learnset.poisonjab = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'zoroarkhisui').learnset.payback = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'vanilluxe').learnset.icespinner = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'foongus').learnset.dazzlinggleam = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'amoonguss').learnset.dazzlinggleam = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'eelektross').learnset.psychicfangs = ['9L1']; // ZA addition
    this.modData('Learnsets', 'eelektross').learnset.muddywater = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'keldeo').learnset.lightscreen = ['9L1']; // ZA addition
    this.modData('Learnsets', 'keldeo').learnset.earthpower = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'meloetta').learnset.agility = ['9L1']; // ZA addition

    // Gen 6:
    this.modData('Learnsets', 'chesnaught').learnset.growth = ['9L1']; // Champions addition
    this.modData('Learnsets', 'chesnaught').learnset.steelroller = ['9L1']; // Champions addition
    this.modData('Learnsets', 'greninja').learnset.flipturn = ['9L1']; // Champions addition
    this.modData('Learnsets', 'greninja').learnset.skittersmack = ['9L1']; // Champions addition
    this.modData('Learnsets', 'greninjabond').learnset.flipturn = ['9L1']; // Champions addition
    this.modData('Learnsets', 'greninjabond').learnset.skittersmack = ['9L1']; // Champions addition
    this.modData('Learnsets', 'diggersby').learnset.fissure = ['9L1']; // Champions addition
    this.modData('Learnsets', 'diggersby').learnset.trailblaze = ['9L1']; // Champions addition
    this.modData('Learnsets', 'talonflame').learnset.blazekick = ['9L1']; // Champions addition
    this.modData('Learnsets', 'talonflame').learnset.skyattack = ['9L1']; // Champions addition
    this.modData('Learnsets', 'talonflame').learnset.whirlwind = ['9L1']; // Champions addition
    this.modData('Learnsets', 'vivillon').learnset.whirlwind = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'floetteeternal').learnset.alluringvoice = ['9L1']; // Champions addition
    this.modData('Learnsets', 'floetteeternal').learnset.batonpass = ['9L1']; // Champions addition
    this.modData('Learnsets', 'floetteeternal').learnset.drainingkiss = ['9L1']; // Champions addition
    this.modData('Learnsets', 'floetteeternal').learnset.lightscreen = ['9L1']; // Champions addition
    this.modData('Learnsets', 'floetteeternal').learnset.pollenpuff = ['9L1']; // Champions addition
    this.modData('Learnsets', 'floetteeternal').learnset.skillswap = ['9L1']; // Champions addition
    this.modData('Learnsets', 'floetteeternal').learnset.storedpower = ['9L1']; // Champions addition
    this.modData('Learnsets', 'floetteeternal').learnset.trailblaze = ['9L1']; // Champions addition
    this.modData('Learnsets', 'floetteeternal').learnset.trick = ['9L1']; // Champions addition
    this.modData('Learnsets', 'florges').learnset.grassyglide = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'pangoro').learnset.comeuppance = ['9L1']; // Champions addition
    this.modData('Learnsets', 'pangoro').learnset.headlongrush = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'furfrou').learnset.crunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'furfrou').learnset.doubleedge = ['9L1']; // Champions addition
    this.modData('Learnsets', 'furfrou').learnset.hyperbeam = ['9L1']; // Champions addition
    this.modData('Learnsets', 'furfrou').learnset.endure = ['9L1']; // Champions addition
    this.modData('Learnsets', 'furfrou').learnset.icefang = ['9L1']; // Champions addition
    this.modData('Learnsets', 'furfrou').learnset.thunderfang = ['9L1']; // Champions addition
    this.modData('Learnsets', 'furfrou').learnset.firefang = ['9L1']; // Champions addition
    this.modData('Learnsets', 'meowstic').learnset.wish = ['9L1']; // Champions addition
    this.modData('Learnsets', 'aegislash').learnset.poltergeist = ['9L1']; // Champions addition
    this.modData('Learnsets', 'aegislash').learnset.zenheadbutt = ['9L1']; // Champions addition
    this.modData('Learnsets', 'aromatisse').learnset.alluringvoice = ['9L1']; // Champions addition
    this.modData('Learnsets', 'aromatisse').learnset.hypnosis = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'heliolisk').learnset.morningsun = ['9L1']; // Champions addition
    this.modData('Learnsets', 'heliolisk').learnset.shedtail = ['9L1']; // Champions addition
    this.modData('Learnsets', 'heliolisk').learnset.trailblaze = ['9L1']; // Champions addition
    this.modData('Learnsets', 'aurorus').learnset.powergem = ['9L1'];
    this.modData('Learnsets', 'aurorus').learnset.voltswitch = ['9L1'];
    this.modData('Learnsets', 'aurorus').learnset.paraboliccharge = ['9L1'];
    this.modData('Learnsets', 'heliolisk').learnset.icespinner = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'hawlucha').learnset.airslash = ['9L1']; // Champions addition
    this.modData('Learnsets', 'carbink').learnset.selfdestruct = ['9L1']; // ZA addition
    this.modData('Learnsets', 'carbink').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'goodra').learnset.gigadrain = ['9L1']; // Champions addition
    this.modData('Learnsets', 'goodrahisui').learnset.steelroller = ['9L1'];
    this.modData('Learnsets', 'goodrahisui').learnset.ancientpower = ['9L1']; // Champions addition
    this.modData('Learnsets', 'klefki').learnset.futuresight = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'gourgeist').learnset.partingshot = ['9L1'];
    this.modData('Learnsets', 'gourgeist').learnset.hypnosis = ['9L1']; // Champions addition
    this.modData('Learnsets', 'gourgeist').learnset.selfdestruct = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'avalugghisui').learnset.ancientpower = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'zygarde').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'diancie').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'crabrawler').learnset.machpunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'crabominable').learnset.hammerarm = ['9L1'];
    this.modData('Learnsets', 'crabominable').learnset.iciclespear = ['9L1']; // Champions addition
    this.modData('Learnsets', 'crabominable').learnset.machpunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'lycanroc').learnset.bonerush = ['9L1'];
    this.modData('Learnsets', 'lycanroc').learnset.earthquake = ['9L1'];
    ...
    this.modData('Learnsets', 'golisopod').learnset.agility = ['9L1']; // ZA addition
    this.modData('Learnsets', 'palossand').learnset.knockoff = ['9L1'];
    this.modData('Learnsets', 'palossand').learnset.fakeout = ['9L1']; // ZA addition
    this.modData('Learnsets', 'palossand').learnset.nastyplot = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'turtonator').learnset.clearsmog = ['9L1'];
    this.modData('Learnsets', 'drampa').learnset.bodyslam = ['9L1']; // Champions addition
    this.modData('Learnsets', 'drampa').learnset.earthpower = ['9L1']; // Champions addition
    this.modData('Learnsets', 'drampa').learnset.triattack = ['9L1']; // Champions addition
    this.modData('Learnsets', 'drampa').learnset.whirlwind = ['9L1']; // Champions addition
    this.modData('Learnsets', 'drampa').learnset.trickroom = ['9L1'];
    this.modData('Learnsets', 'mimikyu').learnset.poltergeist = ['9L1'];
    this.modData('Learnsets', 'mimikyu').learnset.firstimpression = ['9L1'];
    this.modData('Learnsets', 'mimikyu').learnset.uturn = ['9L1'];
    this.modData('Learnsets', 'mimikyu').learnset.strengthsap = ['9L1'];
    this.modData('Learnsets', 'mimikyu').learnset.nightslash = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'necrozma').learnset.dracometeor = ['9M'];
    this.modData('Learnsets', 'necrozmaduskmane').learnset.dracometeor = ['9M'];
    this.modData('Learnsets', 'necrozmadawnwings').learnset.dracometeor = ['9M'];
    this.modData('Learnsets', 'magearna').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'magearna').learnset.powergem = ['9L1']; // ZA addition
    this.modData('Learnsets', 'magearna').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'magearnaoriginal').learnset.vacuumwave = ['9L1']; // ZA addition
    this.modData('Learnsets', 'magearnaoriginal').learnset.powergem = ['9L1']; // ZA addition
    this.modData('Learnsets', 'magearnaoriginal').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'meltan').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'melmetal').learnset.chargebeam = ['9L1']; // ZA addition
    this.modData('Learnsets', 'melmetal').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'greedent').learnset.recycle = ['9L1'];
    this.modData('Learnsets', 'greedent').learnset.slackoff = ['9L1'];
    this.modData('Learnsets', 'corviknight').learnset.featherdance = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'drednaw').learnset.stonesurge = ['9L1'];
    ...
    this.modData('Learnsets', 'toxtricity').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'toxtricitylowkey').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'centiskorch').learnset.uturn = ['9L1'];
    this.modData('Learnsets', 'centiskorch').learnset.recover = ['9L1'];
    this.modData('Learnsets', 'centiskorch').learnset.toxicspikes = ['9L1'];
    this.modData('Learnsets', 'clobbopus').learnset.stormthrow = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'perrserker').learnset.bulkup = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'sirfetchd').learnset.uturn = ['9L1']; // ZA addition
    this.modData('Learnsets', 'mrrime').learnset.chillyreception = ['9L1'];
    this.modData('Learnsets', 'mrrime').learnset.frostbreath = ['9L1']; // Champions addition
    this.modData('Learnsets', 'mrrime').learnset.haze = ['9L1']; // Champions addition
    this.modData('Learnsets', 'mrrime').learnset.icespinner = ['9L1']; // Champions addition
    this.modData('Learnsets', 'mrrime').learnset.sheercold = ['9L1']; // Champions addition
    this.modData('Learnsets', 'mrrime').learnset.swagger = ['9L1']; // Champions addition
    this.modData('Learnsets', 'runerigus').learnset.recover = ['9L1'];
    this.modData('Learnsets', 'runerigus').learnset.partingshot = ['9L1'];
    this.modData('Learnsets', 'runerigus').learnset.gigadrain = ['9L1']; // Champions addition
    this.modData('Learnsets', 'runerigus').learnset.psyshock = ['9L1']; // Champions addition
    this.modData('Learnsets', 'runerigus').learnset.selfdestruct = ['9L1']; // Champions addition
    this.modData('Learnsets', 'alcremie').learnset.moonblast = ['9L1'];
    this.modData('Learnsets', 'falinks').learnset.fakeout = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'indeedee').learnset.chargebeam = ['9L1']; // ZA addition
    this.modData('Learnsets', 'indeedee').learnset.heatwave = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'indeedeef').learnset.chargebeam = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'kleavor').learnset.ancientpower = ['9L1']; // Champions addition
    ...
    // Gen 9
    this.modData('Learnsets', 'skeledirge').learnset.burnup = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'arboliva').learnset.aromatherapy = ['9L1'];
    ...
    this.modData('Learnsets', 'squawkabilly').learnset.bulkup = ['9L1']; // ZA addition
    this.modData('Learnsets', 'garganacl').learnset.dynamicpunch = ['9L1']; // Champions addition
    this.modData('Learnsets', 'armarouge').learnset.burnup = ['9L1']; // Champions addition
    this.modData('Learnsets', 'ceruledge').learnset.burnup = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'mabosstiff').learnset.threateningbite = ['9L1'];
    ...
    this.modData('Learnsets', 'grafaiai').learnset.toxicspikes = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grafaiai').learnset.lightscreen = ['9L1']; // ZA addition
    this.modData('Learnsets', 'grafaiai').learnset.reflect = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'scovillain').learnset.flareblitz = ['9L1']; // Champions addition
    this.modData('Learnsets', 'scovillain').learnset.swagger = ['9L1']; // Champions addition
    this.modData('Learnsets', 'scovillain').learnset.thunderfang = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'tinkaton').learnset.moonlight = ['9L1'];
    this.modData('Learnsets', 'tinkaton').learnset.woodhammer = ['9L1']; // Champions addition
    ...
    this.modData('Learnsets', 'glimmet').learnset.magnetbomb = ['9L1']; // ZA addition
    this.modData('Learnsets', 'glimmora').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'annihilape').learnset.stormthrow = ['9L1']; // ZA addition
    this.modData('Learnsets', 'annihilape').learnset.knockoff = ['9L1']; // ZA addition
    ...
    this.modData('Learnsets', 'baxcalibur').learnset.psychicfangs = ['9L1']; // ZA addition
    this.modData('Learnsets', 'gholdengo').learnset.surf = ['9L1']; // ZA addition
    this.modData('Learnsets', 'gholdengo').learnset.magnetbomb = ['9L1']; // ZA addition
    ...
    const noLearn = ['beldum', 'burmy', 'cascoon', 'caterpie', 'combee', 'cosmoem', 'cosmog', 'ditto', 'kakuna', 'kricketot', 'magikarp', 'metapod', 'necrozmaultra', 'pyukumuku', 'scatterbug', 
